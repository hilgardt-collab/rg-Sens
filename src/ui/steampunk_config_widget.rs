...
impl SteampunkConfigWidget {
    ...
    fn create_frame_page(
        ...
        let border_style_dropdown = builder.dropdown_row(
            &page,
            "Border Style:",
            &["Victorian", "Pipe Frame", "Riveted", "Brass", "Gear Border"],
            style_idx,
            |cfg, idx| {
        ...
        let corner_style_dropdown = builder.dropdown_row(
            &page,
            "Style:",
            &["Gear", "Flourish", "Rivet", "Pipe Joint", "None"],
            corner_idx,
            |cfg, idx| {
        ...
        let gear_teeth_spin = builder.spin_row(
            ...
            24.0,
            1.0,
            config.borrow().frame.gear_teeth as f64,
    ...
    fn create_background_page(
        ...
        let texture_dropdown = builder.dropdown_row(
            &page,
            "Texture:",
            &["Brushed Brass", "Patina", "Leather", "Metal Plate", "Solid"],
            texture_idx,
            |cfg, idx| {
                cfg.frame.background_texture = match idx {
        ...
        let patina_intensity_spin = builder.spin_row(
            ...
            1.0,
            0.1,
            config.borrow().frame.patina_intensity,
        ...
        let patina_color_widget = Rc::new(ThemeColorSelector::new(
            config.borrow().frame.patina_color.clone(),
        ));
        ...
        let show_rivets_check = builder.check_button(
            &page,
            "Show Rivets",
            config.borrow().frame.show_rivets,
        ...
        let rivet_size_spin = builder.spin_row(
            ...
            12.0,
            1.0,
            config.borrow().frame.rivet_size,
        ...
        let rivet_spacing_spin = builder.spin_row(
            ...
            48.0,
            2.0,
            config.borrow().frame.rivet_spacing,
        ...
        let rivet_color_widget = Rc::new(ThemeColorSelector::new(
            config.borrow().frame.rivet_color.clone(),
        ));
    ...
    fn create_header_page(
        ...
        let header_style_dropdown = builder.dropdown_row(
            &page,
            "Style:",
            &["Nameplate", "Banner", "Industrial", "None"],
            style_idx,
            |cfg, idx| {
    ...
    fn create_layout_page(
        ...
        let divider_style_dropdown = builder.dropdown_row(
            &page,
            "Style:",
            &["Pipe", "Gear Chain", "Riveted Bar", "Ornament", "None"],
            div_style_idx,
            |cfg, idx| {
    ...
    fn refresh_all_widgets(&self) {
        ...
        if let Some(ref widgets) = *self.frame_widgets.borrow() {
            ...
            widgets
                .gear_teeth_spin
                .set_value(config.frame.gear_teeth as f64);
        ...
        if let Some(ref widgets) = *self.background_widgets.borrow() {
            widgets
                .texture_dropdown
                .set_selected(match config.frame.background_texture {
                    BackgroundTexture::BrushedBrass => 0,
                    BackgroundTexture::Patina => 1,
                    BackgroundTexture::Leather => 2,
                    BackgroundTexture::MetalPlate => 3,
            ...
            widgets
                .show_rivets_check
                .set_active(config.frame.show_rivets);
            ...
            widgets
                .patina_intensity_spin
                .set_value(config.frame.patina_intensity);
            // Update color selectors (theme_config BEFORE source)
            widgets
                .bg_color_widget
                .set_theme_config(config.frame.theme.clone());
            ...
            widgets
                .patina_color_widget
                .set_source(config.frame.patina_color.clone());
            widgets
                .rivet_color_widget
                .set_theme_config(config.frame.theme.clone());
            widgets
                .rivet_color_widget
                .set_source(config.frame.rivet_color.clone());
        }
    ...
    pub fn cleanup(&self) {
        log::debug!("SteampunkConfigWidget::cleanup() - breaking reference cycles");
