...
use gtk4::prelude::*;
use gtk4::{Box as GtkBox, CheckButton, Label, Notebook, Orientation};
...
impl ConfigWidget for StaticConfigWidget {
    type Config = StaticDisplayConfig;

    fn new(available_fields: Vec<FieldMetadata>) -> Self {
        StaticConfigWidget::new(available_fields)
    }
...
/// Lazy-loading wrapper for StaticConfigWidget.
pub type LazyStaticConfigWidget = LazyConfigWidget<StaticConfigWidget>;
