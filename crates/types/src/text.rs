//! Text displayer configuration types.
//!
//! Contains text positioning, fill, background, and line configuration
//! types used by the text displayer and text overlays.

use serde::{Deserialize, Serialize};

use crate::color::{Color, ColorStop};
use crate::theme::{ColorSource, ColorStopSource, ComboThemeConfig, FontSource};
