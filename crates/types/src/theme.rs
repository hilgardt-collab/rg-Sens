//! Theme system types for combo panels.
//!
//! Provides theme-aware color/font references and the ComboThemeConfig
//! that defines visual presets for different panel styles.

use serde::{Deserialize, Deserializer, Serialize};
use serde_json::Value;

use crate::color::{Color, ColorStop, LinearGradientConfig};
...
impl ComboThemeConfig {
    ...
    pub fn default_for_material_dark() -> Self {
        Self {
            color1: Color::new(0.565, 0.792, 0.976, 1.0), // Blue 200 #90caf9
            color2: Color::new(0.502, 0.796, 0.769, 1.0), // Teal 200 #80cbc4
            color3: Color::new(1.0, 0.702, 0.349, 1.0),   // Orange 300 #ffb74d
            color4: Color::new(0.741, 0.741, 0.741, 1.0), // Gray 400 #bdbdbd
            gradient: LinearGradientSourceConfig {
                angle: 180.0,
                stops: vec![
                    ColorStopSource::custom(0.0, Color::new(0.188, 0.188, 0.188, 1.0)),
                    ColorStopSource::custom(1.0, Color::new(0.141, 0.141, 0.141, 1.0)),
                ],
            },
            font1_family: "Roboto".to_string(),
            font1_size: 14.0,
    ...
    pub fn default_for_material_teal() -> Self {
        Self {
            color1: Color::new(0.0, 0.588, 0.533, 1.0),   // Teal 500 #009688
            color2: Color::new(0.0, 0.447, 0.420, 1.0),   // Teal 700 #00796b
            color3: Color::new(1.0, 0.341, 0.133, 1.0),   // Deep Orange #ff5722
            color4: Color::new(0.459, 0.459, 0.459, 1.0), // Gray #757575
            gradient: LinearGradientSourceConfig {
                angle: 180.0,
                stops: vec![
                    ColorStopSource::custom(0.0, Color::new(0.878, 0.949, 0.945, 1.0)),
                    ColorStopSource::custom(1.0, Color::new(0.757, 0.890, 0.882, 1.0)),
                ],
            },
            font1_family: "Roboto".to_string(),
            font1_size: 14.0,
    ...
    pub fn default_for_material_purple() -> Self {
        Self {
            color1: Color::new(0.404, 0.227, 0.718, 1.0), // Deep Purple 500 #673ab7
            color2: Color::new(0.482, 0.416, 0.882, 1.0), // Deep Purple 300 #7b6ae1
            color3: Color::new(0.0, 0.898, 0.694, 1.0),   // Teal A400 #00e5b1
            color4: Color::new(0.620, 0.620, 0.620, 1.0), // Gray 500 #9e9e9e
            gradient: LinearGradientSourceConfig {
                angle: 180.0,
                stops: vec![
                    ColorStopSource::custom(0.0, Color::new(0.188, 0.141, 0.251, 1.0)),
                    ColorStopSource::custom(1.0, Color::new(0.122, 0.098, 0.176, 1.0)),
                ],
            },
            font1_family: "Roboto".to_string(),
            font1_size: 14.0,
    ...
    pub fn default_for_steampunk() -> Self {
        Self {
            ...
            gradient: LinearGradientSourceConfig {
                angle: 180.0,
                stops: vec![
                    ColorStopSource::custom(0.0, Color::new(0.25, 0.20, 0.15, 1.0)),
                    ColorStopSource::custom(1.0, Color::new(0.15, 0.12, 0.08, 1.0)),
                ],
            },
            font1_family: "Serif".to_string(),
            font1_size: 15.0,
